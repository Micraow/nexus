...
// Maintenance is a graph-wide command, so its single topbar entry must open
// the same panel from every module, including the homepage, reading fragments,
// settings, and task views without a selected maintenance result.
    ...
    <main class="main-shell">
      <header class="topbar">
        ...
        <div class="topbar-actions">
          ...
          <button class="button secondary-button maintenance-entry-button" :aria-expanded="maintenancePanelOpen" @click="openMaintenancePanel"><Sparkles :size="16" />全图维护</button>
