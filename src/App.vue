...
function setConcurrency(value: number): void {
  const concurrency = Math.min(4, Math.max(1, Number(value) || 2))
            ...
            <div v-if="activeConversationSession" class="chat-conversation-workspace conversation-mode">
              ...
              <div class="conversation-layout">
                ...
                <div class="conversation-scroll" role="log" aria-live="polite">
                  <TransitionGroup name="conversation-branch" tag="div" class="conversation-branch-stack" aria-label="当前探索路径">
