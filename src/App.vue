...
const maintenancePageHasContext = computed(() => ['graph', 'concepts', 'sessions'].includes(activeView.value)
  || (activeView.value === 'tasks' && selectedTask.value?.type === 'maintenance'))
      ...
      <section class="content-shell">
        ...
        <section v-else-if="activeView === 'concepts'" class="view-panel concepts-view">
          <div class="page-toolbar">
            ...
            <div class="toolbar-actions"><button class="button secondary-button maintenance-entry-button" :aria-expanded="maintenancePanelOpen" @click="openMaintenancePanel"><Sparkles :size="15" />全图知识维护</button><button class="button secondary-button" @click="setView('graph')"><Network :size="15" />在图谱中查看</button></div>
          </div>
