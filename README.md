...
与大模型的对话越聊越长，读过的回答再难找到，不同会话里的同一个知识各说各的。Nexus 织知把这些线性对话整理成**会话 → 知识单元 → 可递归展开的知识主题**，汇聚成一张可检索、可追溯、可继续追问的知识图谱。
...
| 🕸 **知识图谱** | 图谱默认从一级知识主题开始，点开节点旁的控件逐层查看无限深度的子主题、知识单元和消息；同一会话、消息或知识单元可以同时归属于多个主题，相关关系保持独立，不会制造假的父子层级 |
